 ...
 */
public class MovieContentProviderTest extends AndroidTestCase {

    public static final String LOG_TAG = MovieContentProviderTest.class.getSimpleName();
    ...
    public void testProviderRegistry() {
        ...
        try {
            ...
            assertEquals("Error: ContentProvider registered with authority: " + providerInfo.authority +
                    " instead of authority: " + MovieDataContract.CONTENT_AUTHORITY,
                    providerInfo.authority, MovieDataContract.CONTENT_AUTHORITY);
    ...
    */
    ...
    public void testGetType() {
        // uri: content://net.lezhang.udacity.movie/movie
        String type = mContext.getContentResolver().getType(MovieEntry.CONTENT_URI);
        // type: vnd.android.cursor.item/net.lezhang.udacity.movie/movie
    ...
    */
    public void testBasicMovieQuery() {
        ...
        assertTrue("Unable to insert Movie value into Database", rowId != -1);

        db.close();

        // Test the basic content provider query
        ContentResolver provider = mContext.getContentResolver();
        Cursor movieCursor = provider.query(
                MovieEntry.CONTENT_URI,
                null,
                null,
                null,
